...
export interface IVictimsClient {
    add(command: AddVictimCommand): Observable<number>;
}

@Injectable({
    providedIn: 'root'
})
export class VictimsClient implements IVictimsClient {
    ...
    add(command: AddVictimCommand): Observable<number> {
        let url_ = this.baseUrl + "/api/Victims";
        url_ = url_.replace(/[?&]$/, "");
...
export class AddVictimCommand implements IAddVictimCommand {
    name?: string | undefined;

    constructor(data?: IAddVictimCommand) {
        if (data) {
    ...
    static fromJS(data: any): AddVictimCommand {
        data = typeof data === 'object' ? data : {};
        let result = new AddVictimCommand();
        result.init(data);
        return result;
    }
...
export interface IAddVictimCommand {
    name?: string | undefined;
}
